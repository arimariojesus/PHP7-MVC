    ...
    <div class="card-body">
      ...
      <form action="<?= URL ?>/users/register" name="register" method="POST" class="mt-4">
        <div class="form-group">
          ...
          <input type="text" name="name" id="name" value="<?=$data['name']?>" class="form-control <?= $data['name_error'] ? 'is-invalid' : '' ?>">
        ...
        <div class="form-group">
          ...
          <input type="text" name="email" id="email" value="<?=$data['email']?>"class="form-control <?= $data['email_error'] ? 'is-invalid' : '' ?>">
          <div class="invalid-feedback">
            <?= $data['email_error'] ?>
          </div>
        </div>
        <div class="form-group">
          ...
          <input type="password" name="password" id="password" value="<?=$data['password']?>"class="form-control <?= $data['password_error'] ? 'is-invalid' : '' ?>">
          <div class="invalid-feedback">
            <?= $data['password_error'] ?>
          </div>
        </div>
        <div class="form-group">
          ...
          <input type="password" name="confirm_password" id="confirm_password" value="<?= $data['confirm_password']?>" class="form-control <?= $data['confirm_password_error'] ? 'is-invalid' : '' ?>">
          <div class="invalid-feedback">
